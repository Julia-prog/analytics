...
| 4  | ВНЕУЧЕБНЫЙ [Аналитика данных медицинского центра](https://github.com/Julia-prog/analytics/blob/main/final_AB_test)             | Анализ изменения цен на услуги и прибыли по отчету покупок| Pandas, matplotlib.pyplot
